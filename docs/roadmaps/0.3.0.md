...
- [ ] Автоматическая preflight-проверка зависимостей при старте (`qdrant`, `git`, доступность workspace)
- [ ] Четкий стартовый статус в CLI/log output: `Index ready`, `chunks`, `MCP endpoint`
