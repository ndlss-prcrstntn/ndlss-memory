...
**Input**: Documents from `/specs/001-startup-preflight-summary/`
...
- [X] T031 [US3] Обновить API контракт наблюдаемости старта в `services/mcp-server/openapi/compose-observability.openapi.yaml` и `specs/001-startup-preflight-summary/contracts/startup-preflight-readiness.openapi.yaml`
...
- [X] T035 [P] Обновить feature quickstart в `specs/001-startup-preflight-summary/quickstart.md`
