...
**Ветка**: `011-startup-preflight-summary` | **Дата**: 2026-02-22 | **Спецификация**: `Z:\WORK\ndlss-memory\specs\011-startup-preflight-summary\spec.md`
...
```text
Z:\WORK\ndlss-memory\specs\011-startup-preflight-summary\
|-- plan.md
|-- research.md
|-- data-model.md
|-- quickstart.md
