...
- [ ] Понятные логи статуса индексации
...
- [ ] Настроить лимиты (размер файла, глубина обхода, количество файлов)
- [x] Поддержать конфигурацию через переменные окружения

### 3. Режим Full Scan

- [ ] Реализовать полный обход папки
- [ ] Фильтрация по поддерживаемым типам
